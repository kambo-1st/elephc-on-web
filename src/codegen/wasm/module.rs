...
pub(super) struct WasmModule {
    ...
    callable_target_ids: HashMap<String, i32>,
    next_callable_target_id: i32,
...
impl WasmModule {
    pub(super) fn new(program: &Program) -> Self {
        ...
        let mut module = Self {
            ...
            function_possible_callable_return_targets: collect_function_possible_callable_return_targets(program, &constants),
...
pub(super) struct FunctionBody {
    ...
    possible_callable_targets: HashMap<String, Vec<String>>,
...
impl FunctionBody {
    fn main() -> Self {
        Self {
            ...
            possible_callable_targets: HashMap::new(),
